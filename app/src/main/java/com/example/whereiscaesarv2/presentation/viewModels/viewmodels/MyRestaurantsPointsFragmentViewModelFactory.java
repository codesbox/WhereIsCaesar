...
public class MyRestaurantsPointsFragmentViewModelFactory implements ViewModelProvider.Factory {

    GetRestaurantPointsUseCase getRestaurantPointsUseCase;
    DeletePointUseCase deletePointUseCase;


    public MyRestaurantsPointsFragmentViewModelFactory() {
        ...
        getRestaurantPointsUseCase = new GetRestaurantPointsUseCase(repository);
        deletePointUseCase = new DeletePointUseCase(repository);
    }
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new MyRestaurantsPointsFragmentViewModel(getRestaurantPointsUseCase, deletePointUseCase);
    }
}
